...
public class FindPeak {
	...
	public static void main(String[] args) {
		...
		//construct mapper function in Javascript
		//function () {
	...
	public static void printList(List<Map.Entry<String, Double>> timeList) {
	...
	public static List<LocalTime> initBuckets() {
	...
	//Use LocalTime.isAfter/isBefore to compare to obj
