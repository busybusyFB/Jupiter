(function() {
  ...
  function init() {
    ...
    validateSession();
//    onSessionValid({"user_id":"newUser","password":"newUser","newUser":"OK"});
  }
  ...
  function onLoadPositionFailed() { //If getting location failed.
  ...
  function ajax(method, url, data, successCallback, errorCallback) {
    ...
    xhr.onload = function() { // will be called if the request is sent and the response is received
      if (xhr.status === 200) {
    ...
    xhr.onerror = function() {  // will be called if the request cannot be sent
